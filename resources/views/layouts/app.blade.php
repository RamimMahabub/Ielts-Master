                ...
                <div class="h-full flex flex-col">
                    ...
                    <nav class="p-4 space-y-2 text-sm">
                        ...
                        @if($role === 'admin')
                            ...
                            <a href="{{ route('admin.mock_test') }}" class="block rounded-xl px-4 py-2 {{ request()->routeIs('admin.mock_test*') ? 'bg-indigo-600 text-white' : 'hover:bg-slate-100 dark:hover:bg-slate-800' }}">Mock Test Builder</a>
